...
context_store and all Unimatrix write tools (context_*): PROHIBITED

You evaluate the external world. Project context is in SCOPE.md.
```

**"Write tools" above means the Unimatrix `context_*` tools — NOT the filesystem `Write`
tool.** Writing your `FINDINGS.md` (or `FINDINGS-EXTERNAL.md` in dual-track) to disk is your
**required deliverable**. Do it yourself; do not return findings only in your message and claim
you were "blocked from writing."
